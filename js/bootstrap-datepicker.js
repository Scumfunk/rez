    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            ...
            setTimeout(function(){
                ...
                datepicker.closest('.hide-label-onstart').find('label').css('opacity','1')
            }, 170);
        },
        ...
        set: function() {
            ...
            this.element.closest('.hide-label-onstart').find('label').css('opacity','1')
            if (!this.isInput) {
                if (this.component){
                    this.element.find('input').prop('value', formated);
                    this.element.find('input').closest('.hide-label-onstart').find('label').css('opacity','1')
                }
